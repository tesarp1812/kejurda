...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Feb 2023 pada 04.40
...
INSERT INTO `anggota` (`id_anggota`, `nama`, `divisi`) VALUES
(1, 'tesar', 'perkap'),
(2, 'budi', 'acara');
...
INSERT INTO `peminjaman` (`id_peminjaman`, `tgl_pinjam`, `id_barang`, `jumlah`, `id_anggota`) VALUES
(1, '2022-10-05', 4, 2, 1),
(2, '0000-00-00', 3, 0, 2);
